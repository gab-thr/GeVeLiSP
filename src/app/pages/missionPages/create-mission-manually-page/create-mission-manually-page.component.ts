...
@Component({
  selector: 'app-create-mission-manually-page',
  templateUrl: './create-mission-manually-page.component.html',
  styleUrls: ['./create-mission-manually-page.component.css']
})
export class CreateMissionManuallyPageComponent implements OnInit {
